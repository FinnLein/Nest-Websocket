...
-- CreateIndex
CREATE INDEX "chat_participants_chat_id_user_id_idx" ON "chat_participants"("chat_id", "user_id");

-- CreateIndex
CREATE INDEX "messages_chat_id_sender_id _idx" ON "messages"("chat_id", "sender_id ");
...
-- AddForeignKey
ALTER TABLE "messages" ADD CONSTRAINT "messages_sender_id _fkey" FOREIGN KEY ("sender_id ") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
